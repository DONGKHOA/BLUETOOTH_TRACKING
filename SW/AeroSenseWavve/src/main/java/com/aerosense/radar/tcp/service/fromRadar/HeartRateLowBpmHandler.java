 ...
 */
@Service
public class HeartRateLowBpmHandler extends AbstractFromRadarProtocolDataHandler {
    public HeartRateLowBpmHandler(RadarHandlerCallBack handlerCallBack) {
        super(handlerCallBack);
    }

    @Override
    public Object process(RadarProtocolData protocolData) {
        protocolData.setFunction(FunctionEnum.heartRateLowBpm);
    ...
    public Set<FunctionEnum> interests() {
        return Sets.newHashSet(FunctionEnum.heartRateLowBpm);
    }
}
