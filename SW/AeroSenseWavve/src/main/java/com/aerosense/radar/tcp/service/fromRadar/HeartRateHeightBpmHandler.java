 ...
 */
@Service
public class HeartRateHeightBpmHandler extends AbstractFromRadarProtocolDataHandler {
    public HeartRateHeightBpmHandler(RadarHandlerCallBack handlerCallBack) {
        super(handlerCallBack);
    }

    @Override
    public Object process(RadarProtocolData protocolData) {
        protocolData.setFunction(FunctionEnum.heartRateHighBpm);
    ...
    public Set<FunctionEnum> interests() {
        return Sets.newHashSet(FunctionEnum.heartRateHighBpm);
    }
}
