...
//   while (1)
//   {
//     while (DEV_AS608_GenImg(default_address) != 0)
//     {
//       printf("Fingerprint not detected!\n");
//     }

//     u8_confirmation_code = DEV_AS608_Img2Tz(default_address, buffer1);
...
//         = DEV_AS608_Search(default_address, buffer1, start_page, page_number);
//     if (u8_confirmation_code == 0)
//     {
...
//   while (1)
//   {
//     DEV_AS608_TempleteNum(default_address, &u16_stored_fingerprints);
...
//     DEV_AS608_Img2Tz(default_address, buffer1);
...
//     DEV_AS608_Img2Tz(default_address, buffer2);

//     u8_confirmation_code = DEV_AS608_RegModel(default_address);
//     if (u8_confirmation_code == 0)
//     {
//       u8_confirmation_code
//           = DEV_AS608_Search(default_address, buffer1, start_page, page_number);
...
//         printf("Fingerprint not detected!\n");
//         u8_confirmation_code
//             = DEV_AS608_Store(default_address, buffer1, u8_page_id);
//         if (u8_confirmation_code == 0)
//         {
...
// {
//   uint8_t u8_confirmation_code
//       = DEV_AS608_DeletChar(default_address, start_page, page_number);
//   if (u8_confirmation_code != 0)
//   {
