...
#define RS485_FUNC_READ_HOLDING_REGS 0x03 // Read holding registers
#define RS485_FUNC_READ_INPUT_REGS   0x04 // Read input registers
#define RS485_FUNC_WRITE_SINGLE_REG  0x06 // Write single register
#define RS485_FUNC_WRITE_MULTI_REGS  0x10 // Write multiple registers
  ...
  void DEV_RS485_SendRequest(rs485_request_t *request);
   ...
   */
  uint8_t DEV_RS485_ReceiveResponse(uint8_t *buffer);
