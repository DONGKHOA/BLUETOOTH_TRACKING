...
void
_ui_bar_set_property (lv_obj_t *target, int id, int val)
{
...
void
_ui_basic_set_property (lv_obj_t *target, int id, int val)
{
...
void
_ui_dropdown_set_property (lv_obj_t *target, int id, int val)
{
...
void
_ui_image_set_property (lv_obj_t *target, int id, uint8_t *val)
{
...
void
_ui_label_set_property (lv_obj_t *target, int id, const char *val)
{
...
void
_ui_roller_set_property (lv_obj_t *target, int id, int val)
{
...
void
_ui_slider_set_property (lv_obj_t *target, int id, int val)
{
...
void
_ui_screen_change (lv_obj_t         **target,
...
void
_ui_screen_delete (lv_obj_t **target)
{
  if (*target == NULL)
  {
    lv_obj_del(*target);
...
void
_ui_arc_increment (lv_obj_t *target, int val)
{
...
void
_ui_bar_increment (lv_obj_t *target, int val, int anm)
{
...
void
_ui_slider_increment (lv_obj_t *target, int val, int anm)
{
...
void
_ui_keyboard_set_target (lv_obj_t *keyboard, lv_obj_t *textarea)
{
  lv_keyboard_set_textarea(keyboard, textarea);
}

void
_ui_flag_modify (lv_obj_t *target, int32_t flag, int value)
{
...
void
_ui_state_modify (lv_obj_t *target, int32_t state, int value)
{
...
void
_ui_textarea_move_cursor (lv_obj_t *target, int val)
...
void
scr_unloaded_delete_cb (lv_event_t *e)
...
void
_ui_opacity_set (lv_obj_t *target, int val)
{
  lv_obj_set_style_opa(target, val, 0);
}

void
_ui_anim_callback_free_user_data (lv_anim_t *a)
{
...
void
_ui_anim_callback_set_x (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_y (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_width (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_height (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_opacity (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_image_zoom (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_image_angle (lv_anim_t *a, int32_t v)
...
void
_ui_anim_callback_set_image_frame (lv_anim_t *a, int32_t v)
...
int32_t
_ui_anim_callback_get_x (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_y (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_width (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_height (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_opacity (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_image_zoom (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_image_angle (lv_anim_t *a)
...
int32_t
_ui_anim_callback_get_image_frame (lv_anim_t *a)
...
void
_ui_arc_set_text_value (lv_obj_t   *trg,
                        lv_obj_t   *src,
                        const char *prefix,
                        const char *postfix)
{
  ...
  lv_snprintf(
      buf, sizeof(buf), "%s%d%s", prefix, (int)lv_arc_get_value(src), postfix);

  lv_label_set_text(trg, buf);
}

void
_ui_slider_set_text_value (lv_obj_t   *trg,
                           lv_obj_t   *src,
                           const char *prefix,
                           const char *postfix)
{
  ...
  lv_snprintf(buf,
              ...
              "%s%d%s",
              prefix,
              (int)lv_slider_get_value(src),
              postfix);

  lv_label_set_text(trg, buf);
}
void
_ui_checked_set_text_value (lv_obj_t   *trg,
                            lv_obj_t   *src,
                            const char *txt_on,
                            const char *txt_off)
{
...
void
_ui_spinbox_step (lv_obj_t *target, int val)
