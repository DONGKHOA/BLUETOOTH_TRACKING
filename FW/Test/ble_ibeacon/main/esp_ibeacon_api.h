...
/****************************************************************************
 *
 * This file is for iBeacon definitions. It supports both iBeacon sender and
 *receiver which is distinguished by macros IBEACON_SENDER and IBEACON_RECEIVER,
 *
...
/* Espressif WeChat official account can be found using WeChat "Yao Yi Yao Zhou
 * Bian", if device advertises using ESP defined UUID. Please refer to
 * http://zb.weixin.qq.com for further information. */
#define ESP_UUID                                    \
...
esp_err_t esp_ble_config_ibeacon_data(esp_ble_ibeacon_vendor_t *vendor_config,
