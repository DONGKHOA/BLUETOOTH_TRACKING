...
/* Logging configurations */
#if CONFIG_DEVICE_DEFENDER_LOG_ERROR || CONFIG_DEVICE_DEFENDER_LOG_WARN || CONFIG_DEVICE_DEFENDER_LOG_INFO || CONFIG_DEVICE_DEFENDER_LOG_DEBUG

    /* Set logging level for the Device Defender component to highest level,
    ...
    /* Change LIBRARY_LOG_NAME to "DeviceDefender" if defined somewhere else. */
