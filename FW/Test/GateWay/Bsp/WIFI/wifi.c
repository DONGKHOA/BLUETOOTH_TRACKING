 ...
 * @param pass The `pass` parameter in the `WIFI_ScanNVS` function is a pointer
 * to a uint8_t array where the password of the WiFi network will be stored if
 * the corresponding SSID is found during the scan.
 *
